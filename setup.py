...
setup(
    name="choremate",  # Replace with your app's name
    ...
    url="https://github.com/dagraham/choremate",  # Replace with the repo URL if applicable
    packages=find_packages(),
    include_package_data=True,  # Include non-Python files specified in MANIFEST.in
    package_data={
        "chores": ["README.txt"],  # Ensure README.txt is included in the trf package
    },  # py_modules=["trf"],
    classifiers=[
